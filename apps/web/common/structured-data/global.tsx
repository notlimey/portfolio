...
const jsonLd = {
    ...
    "@graph": [
        ...
        },
        {
            ...
            "address": {
                "@type": "PostalAddress",
                "addressLocality": "Oslo/Bergen/Trondheim/Hamar/Kristiansand/Stockholm/Malmö"
            }
        },
        {
            "@type": "Corporation",
            ...
            "url": "https://3steps.no",
            "description": "Data platform for statistics and management of sports teams and organizations."
        },
        {
            "@type": "Organization",
            "@id": "#limeyfyas",
            ...
            "description": "Company offering services in web development, consulting, investments, and design."
        },
        {
            "@type": "WebSite",
            "url": "https://mkmyhre.com",
